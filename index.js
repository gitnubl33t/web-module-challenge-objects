...
const burger = {
  ...
  discount: function (type) {
    ...
    if (type === "student" || type === "teacher") {
      discountPrice = burger.price * 0.75;
    } else {
...
const shake = createMenuItem("Milkshake", 2, "Lunch");
const chkSandwich = createMenuItem("Chicken Sandwich", 4, "Lunch");

// console.log(latte, burger, breakfastBurrito, pizza, shake, chkSandwich);
...
function getReviewByIndex(reviews, index) {
  ...
  reviewStr =
    ...
    " star rating and their feebdack was: " +
